    ...
    return (
        <div className="add__main">
            <div className="add__container">
                <h2 className="text-center">Add an Actor</h2>
                <Form onSubmit={handleSubmit} enctype="multipart/form-data">
                    <FormGroup className="login__container_form">
                        <label htmlFor="username">Name:</label>
                        <input type="text" placeholder="Add Actor's Name" required id="username" value={actorDetails.username} onChange={handleChange} />
                    </FormGroup>
                    <FormGroup className="login__container_form">
